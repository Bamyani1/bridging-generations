  ...
  return (
    <fieldset className={containerClass}>
      ...
      {options.map((option) => {
        ...
        const base =
          "inline-flex min-h-[44px] items-center gap-1 border border-hairline px-4 py-2 text-body-sm transition focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent";
