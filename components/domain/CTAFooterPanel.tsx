...
export function CTAFooterPanel({
  ...
  return (
    <section aria-labelledby={titleId} className={`${surfaceClass} py-24 lg:py-[140px]`}>
      <div className="mx-auto flex max-w-[1280px] flex-col items-start gap-8 px-4 sm:px-6 lg:px-[6%]">
